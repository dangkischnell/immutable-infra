...
4. packer build  -var aws_access_key="root_access_key" -var aws_secret_key="root_access_secret" -var-file variables.json packer.json
5. export role_name=web
6. packer build  -var aws_access_key="root_access_key" -var aws_secret_key="root_access_secret" -var-file variables.json packer.json
